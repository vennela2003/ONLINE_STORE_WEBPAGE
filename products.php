...
<html>
    <head>
        ...
        <title>Treasure Heaven Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Treasure Heaven Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="#">Treasure Heaven Store</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Vidya Gowda</p>
               </center>
               </div>
           </footer>
        </div>
